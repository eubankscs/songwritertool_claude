...
contextBridge.exposeInMainWorld('songwriterAPI', {
  ...
  songs: {
    ...
    getAllActive: () => ipcRenderer.invoke('songs:getAllActive'),
    ...
    purgeOldDeleted: () => ipcRenderer.invoke('songs:purgeOldDeleted'),
    permanentlyDelete: (songId: string) => ipcRenderer.invoke('songs:permanentlyDelete', songId),
    restore: (songId: string, targetProjectId: string) => ipcRenderer.invoke('songs:restore', songId, targetProjectId),
    restorePermanent: (songId: string, targetProjectId: string) => ipcRenderer.invoke('songs:restorePermanent', songId, targetProjectId),
    restoreAsVariant: (originalSongId: string, newTitle: string, targetProjectId: string) => ipcRenderer.invoke('songs:restoreAsVariant', originalSongId, newTitle, targetProjectId),
    checkTitleInProject: (title: string, projectId: string, excludeId?: string) => ipcRenderer.invoke('songs:checkTitleInProject', title, projectId, excludeId),
    moveToProject: (songId: string, targetProjectId: string) => ipcRenderer.invoke('songs:moveToProject', songId, targetProjectId),
    createVariant: (originalSongId: string, newTitle: string, targetProjectId: string) => ipcRenderer.invoke('songs:createVariant', originalSongId, newTitle, targetProjectId),
    saveAsVariant: (originalSongId: string, newTitle: string, targetProjectId: string) => ipcRenderer.invoke('songs:saveAsVariant', originalSongId, newTitle, targetProjectId),
  },
  songVersions: {
